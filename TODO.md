...
- [ ] Min wages: stage `budget_crawler/min_wage/` for v0.2.0; implement TN, KA, MH
...
- [ ] `budget_crawler/case_status/` module: eCourts + SC portal case-number → verified status CSV
- [ ] ICDS publication draft: op-ed or blog lede
...
- [x] 2026-05-20 — v0.1.0 tagged and pushed to CommonerLLP/budget-crawler on GitHub
...
- [x] 2026-05-16 — Min wage scraper framework created (`budget_crawler/min_wage/`); Kerala test case complete
